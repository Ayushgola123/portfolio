            ...
            <div className={styles.main} ref={navbar}>
                <div className={styles.container}>
                    <div className={styles.logo}>
                        <a href="#">
                            <img src="/aylogo_adobe_express.svg" alt="logo" />
                        </a>
                    </div>
                    <div className={styles.options}>
                        <a
                            href="https://github.com/Ayushgola123"
                            target="_blank"
                        ...
                        <a
                            href="https://www.linkedin.com/in/ayush-gola-67b617208/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg viewBox="0 0 24 24" fill="none">
                        ...
                        <a
                            ...
                            download="public/resume2414_pdf.pdf"
                        >
                            Resume
                        </a>
                    </div>
